 ...
 *
 */
public class Cowcatcher extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    Jaguar cowcatcherJag = RobotMap.cowcatchercowcatcherJag;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new CowcatcherStay());
    ...
    public void raise(){
        cowcatcherJag.set(raiseSpeed);
    }
    
    public void lower(){
        cowcatcherJag.set(lowerSpeed);
    }
    
    public void stay(){
        cowcatcherJag.set(0.0);
    }
}
