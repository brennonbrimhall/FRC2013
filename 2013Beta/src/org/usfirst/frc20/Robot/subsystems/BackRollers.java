 ...
 *
 */
public class BackRollers extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    Jaguar backRollersJag = RobotMap.backRollersbackRollersJag;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new BackRollersOff());
    ...
    public void backdrive(){
        backRollersJag.set(backDriveSpeed);
    }
