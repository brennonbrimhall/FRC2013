...
public class RobotMap {
    ...
    public static DoubleSolenoid lifterLifterCylinder;
    ...
    public static DoubleSolenoid indexerstopperCylinder;
    public static DoubleSolenoid indexerkickerCylinder;
	...
	LiveWindow.addSensor("Drivetrain", "rightEncoder", drivetrainrightEncoder);
        ...
        trayanglerCylinder = new DoubleSolenoid(1, 1, 2);      
	...
	LiveWindow.addActuator("Collector", "rollerMotor", (Talon) collectorrollerMotor);
        ...
        lifterLifterCylinder = new DoubleSolenoid(1, 3, 4);     
	...
	LiveWindow.addActuator("Shooter", "flywheel", (Talon) shooterflywheel);
        ...
        indexerstopperCylinder = new DoubleSolenoid(1, 5, 6);
        indexerkickerCylinder = new DoubleSolenoid(1, 7, 8);
